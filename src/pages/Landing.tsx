      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-16 sm:py-20">
        ...
        >
          <div>
            ...
            <motion.h2 variants={fadeUp} className="type-display mt-3">
...
/** Feed the .spotlight overlay with cursor position. */
...
export default function Landing() {
  ...
  const potStats: {
    ...
    { label: "On the board", cents: stats?.potCents, icon: <Trophy className="size-4" />, foot: "total banked" },
    { label: "Sabotage paid", cents: stats?.sabotageCents, icon: <ThumbsDown className="size-4" />, foot: "drag-downs on rivals" },
    { label: "Paid moves", value: stats?.bidCount, icon: <Gavel className="size-4" />, foot: "receipts on file" },
    { label: "Products listed", value: stats?.listingCount, icon: <Boxes className="size-4" />, foot: "live on the board" },
  ];
          ...
          <TiltCard className="relative hairline">
            ...
            >
              ...
              <div className="flex items-center gap-3 border-b border-border/40 bg-secondary/30 px-4 py-1.5">
                <span className="w-8 text-center font-label text-[9px] uppercase tracking-wide text-muted-foreground/60">rank</span>
                <span className="flex-1 font-label text-[9px] uppercase tracking-wide text-muted-foreground/60">product</span>
                <span className="pr-1 font-label text-[9px] uppercase tracking-wide text-muted-foreground/60">bank</span>
              </div>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-0.5 flex items-center gap-1.5 text-[11px] text-muted-foreground">
                        ...
                        <span className="truncate">{r.cat.slice(r.cat.indexOf(" ") + 1)}</span>
                      </p>
                    </div>
                    {r.locked ? (
              ...
              <div className="flex items-center gap-2 border-t border-border/60 bg-card/40 px-4 py-2.5">
                <span className="rounded-full border border-border/60 px-2 py-0.5 font-label text-[9px] uppercase tracking-wide text-muted-foreground">vs</span>
          ...
          >
            <div className="flex flex-wrap items-end justify-between gap-4">
              <div>
                ...
                <motion.h2 variants={fadeUp} className="type-display mt-3 text-background">
                  Top inviters.
                </motion.h2>
              </div>
              <motion.p
